...
public class TweetsAgainstHumanity {
    public static void main(String[] args){
        ...
        List<String> nationality = new ArrayList<String>(Arrays.asList("Mongolia","India","USA","Japan","Ethiopia","Nepal"));
        List<Integer> ages = new ArrayList<Integer>(Arrays.asList(18,25,37,32,33,53,51,27,49,57,22,31,19,54,76,88,103,24,26));
        List<String> name = new ArrayList<String>(Arrays.asList("James","John","Robert","Michael","Jack","Dennis","Jerry","Tyler","Aaron","Jose","Henry","Douglas","Adam","Peter","Nathan","Zachary","Walter","Kyle","Harold","Carl","Jeremy","Keith","Roger","Gerald","Ethan","Arthur","Terry","Ashley","Tom","Enkhbold","Jav guru","Maharishi","Guthrie","Sickler","Terminator","Chris","Sandeep","Tumurtogoo","Chinggis","Ichiban","Jan Woo","John","Kim","Rajesh","Trevor","Noah"));
        ...
        BiFunction<List<Topic>,Long,List<Tweet>> genTweetsByL=(topicList,n)->
